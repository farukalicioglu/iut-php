...
Due to Covid-19 process, the organization will apply the rules in line with the announced recommendations for measures and practices by the Ministry of Health and the Athletics Federation (<a href="https://www.runfiresaltlake.com/files/ozel_yarismalar_kilavuzu.docx" target="_blank">Athletics Federation of Turkey’s special contests manual</a>). Depending on the pandemic process, the rules can be updated and changed. All rule updates will be posted on the event’s official "Race Rules" page. The participants are obliged to follow these rules regularly until the race day.
						...
						<p>
							...
							<br />- For 100K runners, there will be 1 CP dedicated for DROP BAG area. Runners may use the bags that they will deliver beforehand in this CP.
...
 * Women / Men 50+ (BD: 1971 and before)<br />
  ...
  <tbody>
    ...
    <tr style="background-color: rgb(245, 246, 247);">
      ...
      <td style="padding-left: 4px;">₺380</td>
    </tr>
  </tbody>
</table>
...
 • No REFUND will be made for the cancellation made after <?php echo $tarih_1; ?>.
...
• Participants are supposed to deliver their health report (For categories over 20 km) • Participants have to present the mandatory equipment in order to collect the bib numbers. <br />
• Registration fees or chest numbers cannot be transferred to another athlete. <br />
• If it is desired to make changes in the categories after the final registration, *A fee with a lower participation fee will not be charged for a pass. *A charge difference is added to a categorization with a higher participation fee. Changes / transitions between categories cannot be performed after the registration is closed.
<br /><br />
<strong>Services Included in Participancy Fee:</strong><br />

- Minimum 70% alcohol-based disinfectant<br />
- Minimum 5 medical masks<br />
- Pen<br />
- Health Report<br />
- Mobile phone<br />
- Whistle<br />
