    ...
    <title>İstanbul Ultra Trail</title>
		<style type="text/css">
			.popup-uzunetap{
				...
				width: 100%;
				height: 100%;
				background: url("https://uzunetap.com/files/iu_popup_2021.png");
				z-index: 9999;
				text-align: center;

				display:none;
			}
			.popup-uzunetap .image-area{
				margin-top: 20px;
			}
			.popup-uzunetap .image-area a{

			}
			.popup-uzunetap .image-area a img{
				width: 40%;
			}
			.popup-uzunetap .image-area a.close-popup{
				color:#df582c;
				font-weight: bold;
				font-size: 24px;
			}
...
<body>
	<!-- POPUP -->
		<div class="popup-uzunetap">
			<div class="image-area">
				<a href="javascript:close_popup();"><img src="../files/popup/iu_popup_erteme_2_tr.jpg" /></a>
				<a href="javascript:close_popup();" class="close-popup">x</a>
			</div>
		</div>
	<!-- POPUP -->
<!-- PAGELOADER -->
            ...
            <div id="revolutionslider1" class="revolution-slider"  data-version="5.0">
                <ul>
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide1.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide2.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide3.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide4.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide5.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide6.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
                    <li class="text-light" data-transition="fade" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="../files/slider2021/Slide7.jpeg?v=2"  alt=""  width="1920" height="1080">
                    </li> <!-- END slide -->
              	</ul>
        ...
        <div class="column-section boxed-sticky adapt-height vertical-center clearfix">
          ...
          <a href="?p=iu-100K"><img src="../files/anasayfaboxes/100.png" style="width:150px;" alt="IU-100K"></a>
             <h5 style="margin-top:10px !important;"><strong>IU-100K</strong></h5>
              <p><em>İstanbul’un yemyeşil ormanlarından Karadeniz’in masmavi sularına uzanan 100 km’lik ULTRA macera! </em>

</p>
<img src="../files/anasayfaboxes/iu100-boxgrafik.png?v=1" style="margin:20px 0;" />
<br>
...
<img src="../files/anasayfaboxes/iu60-boxgrafik.png?v=1" style="margin:20px 0;" />
<br>
<a href="?p=iu-60K" class="sr-button button-1 button-tiny rounded" title="IU-60K hakkında detaylı bilgi almak için burayı tıklayınız.">detaylı bilgi</a>
          ...
          <a href="?p=iu-30K"><img src="../files/anasayfaboxes/30.png" style="width:150px;" alt="IU-30K"></a>
             <h5 style="margin-top:10px !important;"><strong>IU-30K</strong></h5>
              <p><em>İstanbul’un kuzey ormanlarında 30km’lik keyifli bir patika koşusuna hazır mısınız?</em>
</p>
<img src="../files/anasayfaboxes/iu30-boxgrafik.png?v=1" style="margin:20px 0;" />
<br>
...
<img src="../files/anasayfaboxes/iu15-boxgrafik.png?v=1" style="margin:20px 0;" />
<br>
