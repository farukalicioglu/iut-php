			...
			<div class="tabs vertical-tabs">
				...
				<div class="tab-container clearfix faruk">
					<div class="tab-content tab1">
						...
						<p>From beginners to proffessionals; here is IU-15K for who would like to enjoy this exciting trail experience in 15 km long race course!</p>
...
<iframe src="https://ridewithgps.com/embeds?type=trip&id=31854032&metricUnits=true&sampleGraph=true" style="width: 1px; min-width: 100%; height: 700px; border: none;" scrolling="no"></iframe>
						...
						<p>Entire race course will be marked in every 50-100 m for both day and night.</p><br><br>

												<p>
Route		         	: <a href="https://ridewithgps.com/trips/31854032" target="_blank">https://ridewithgps.com/trips/31854032</a>
							<h5>GPX Download Links</h5>
GARMIN GPX Route	: <a href="https://connect.garmin.com/modern/course/25302572" target="_blank">https://connect.garmin.com/modern/course/25302572</a><br>
SUUNTO GPX Route	: <a href="http://www.movescount.com/map?route=4649037" target="_blank">http://www.movescount.com/map?route=4649037</a>
						</p>
			...
			<td>03:00:00</td>
					...
					<div class="tab-content tab4">
						...
						<p>
							...
							<br />- There is a contingent for each category. If the contingent is filled for a category, priority belongs to registered (who completed the payment) participant.
...
All registered runners are deemed to have accepted all of the race rules.
	...
	-	There will only be  general men and general women classifications in 15K category. No age classification will be made in IU-15K.<br />
							<br />
<strong>The classification for 30K / 60K / 100K categories will be as follows:</strong><br />
...
 * Women / Men 50+ (BD: 1971 and before)<br />
  ...
  <tbody>
    ...
    <tr style="background-color: rgb(245, 246, 247);">
      <td style="padding-left: 4px;">₺180</td>
...
<?php include('tab7_kayitli_katilimcilar.php'); ?>
					...
					<div class="tab-content tab8">
						...
						<p>
						<strong>Mandatory Equipment for 15K:</strong><br />
...
<br /><br />
	-	Hot weather and the long course should be taken in to consideration for the course comprises sharp descents and ascents, rough and varying terrains. Running all through the course might be hard. A fast walk may be required at some places.
							<br /><br />
							Running/walking ratio varies according to the performance of the competitor. Therefore:<br />
...
<br />
<strong>Advise for equipment:</strong><br />
<br />
