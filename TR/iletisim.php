...
<head>
    ...
    <link href="../files/fonts/ubuntu.css" rel="stylesheet" type="text/css">
...
<div id="page-content">
	...
	<?php require_once __DIR__.'/static-includes/nav.php'; ?>
     ...
     <!-- HERO  -->
	<section id="hero" class="hero-auto text-light parallax-section" data-parallax-image="<?php echo $detay_header_img; ?>">
