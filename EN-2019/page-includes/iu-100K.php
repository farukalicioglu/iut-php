			...
			<div class="tabs vertical-tabs">
				...
				<div class="tab-container clearfix faruk">
					<div class="tab-content tab1">
						<!-- START .tab-content -->
						<h4 class="align-left"><strong>İU-100K</strong></h4>
						<img src="../files/detaygrafik/iu-100k-detaygrafik.png" style="margin:10px 0 20px 0;">
						<p>From the northern forests’ green to shores of Black Sea… A hundred km long ULTRA adventure! Get ready for the first 100K ultra trail race of Istanbul!</p>
					...
					<div class="tab-content tab2">
						...
						<p>Total cut-off time for 100K is 20 hours. There will be checkpoints in every 10 km in average.
Entire race course will be marked in every 50-100 m for both day and night.</p>
						<p>Participants may deliver their desired bag to be kept in the DropBag CP in order to use it during the race. The <strong>DROPBAG</strong> area will be in CP5 (in 48 km).<br>
Runners are allowed to use their bags only 1 time in the race.</p>
<br><br>
						<p>
						Route			: <a href="https://ridewithgps.com/trips/35788482" target="_blank">https://ridewithgps.com/trips/35788482</a>
							<h5>GPX download links</h5>
GARMIN GPX Route	: <a href="https://connect.garmin.com/modern/course/25358697" target="_blank">https://connect.garmin.com/modern/course/25358697</a><br>
SUUNTO GPX Route	: <a href="http://www.movescount.com/map?route=4649063" target="_blank">http://www.movescount.com/map?route=4649063</a>
						</p>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Registrations & Kit Delivery (Sports International Tepe Nautilus Kulübü / Kadıköy)</td>
    </tr>
    <tr>
      <td><strong>20:30 – 21:30 </strong></td>
      <td>100K / 60K Technical Briefing (Sports International Tepe Nautilus Kulübü / Kadıköy)</td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td>100K Award Ceremony</td>
					...
					<div class="tab-content tab4">
						...
						<p>
	-	Course must be completed in designated periods and conditions. Otherwise the race will not be coounted as completed.  
							<br />
	...
	-	Cancellation and Refund policies are stated in the “Participation Fee” section.
							<br />
	-	Registrations close on June 17th, 2019. Switching between categories is not possible after registration closes. 
							<br />
	-	All categories -EXCEPT 15K- must present their health report indicating that there is no obstacle to compete in the race. Kindly send your report’s copy to info@uzunteap.com and bring the original report to the event area. 
							<br />
							<a href="http://istanbulultratrail.com/files/istanbul-ultra-saglik-belgesi.docx" target="_blank">→ Click here for health report example.</a> 
...
<br />
	...
	-	Competitors may get sponsors. They are allowed to wear sponsor logo on their chests or backpacks as long as they don't cover the race number. Visibility of sponsor logos apart from these two locations is decided by the organization comitee.  
							<br />
	-	Competitors may discontinue the race at any point. The organization staff must be acknowledged and the document for discontinuation must be signed. ID cards are refunded at this point and race cannot be continued but the competitor is free to run the rest of the stages. No refunds will be paid in case of discontinuance.
							<br />
	-	No refunds will be paid in case of absence of the mandatory equipment or breaking any of the rules above and in case of disqualification by the referee decision.
							<br />
	-	No Money reward will be given. Ranking athletes will receive trophy and the medal.
							<br />
...
All registered runners are deemed to have accepted all of the race rules.</p>
...
$select_cr=mysql_query("SELECT user_id, event_id, category_id, payment_status FROM t2_competitor_events WHERE payment_status='1' AND event_id='21' ORDER BY payment_time ASC");
				...
				?>
					...
					<div class="tab-content tab8">
						...
						<p>
						<strong>Mandatory Equipment for 100K:</strong><br />
- Health Report<br />
- Mobile phone<br />
- Whistle<br />
