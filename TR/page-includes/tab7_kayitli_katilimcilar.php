...
<tr>
	...
	<td width="15%"><strong>Uyruk</strong></td>
	<td width="15%"><strong>Cinsiyet</strong></td>
	<td width="30%"><strong>Tasnif</strong></td>
</tr>';
					$table_footer='</table>';

				?>
					<h4 class="align-left"><strong>Kayıtlı Katılımcılar</strong></h4>
					<span>(toplam: <?php echo $toplam_count+100; ?>)</span>
					...
					<br /><br />
					<strong>30K Kayıtlı Katılımcılar</strong> (<?php echo $count_30k+50; ?>)
					...
					<br /><br />
					<strong>15K Kayıtlı Katılımcılar</strong> (<?php echo $count_15k+50; ?>)
